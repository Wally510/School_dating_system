...
class Account(db.Model):
    ...
    pmlist = db.Column(db.String(360))
...
class Ban(db.Model):
    ...
    j_username = db.Column(db.String(12), primary_key=True)
    banreason = db.Column(db.String(8), nullable=True)
    banstart = db.Column(db.Date, nullable=True)
    banend = db.Column(db.Date, nullable=True)
    unbantime = db.Column(db.Integer, nullable=True)
    # Foreign key relationship
    # account = db.relationship('Account', backref='ban', uselist=False)